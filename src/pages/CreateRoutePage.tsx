...
const CreateRoutePage: React.FC = () => {
  ...
  const fetchRoute = async (startLat: number, startLon: number, endLat: number, endLon: number, mode: string) => {
    try {
      ...
      const apikey = '5b3ce3597851110001cf6248d85f427c71894eb987dd971ab317c6fd'; 
  ...
  const handleFieldUpdate = async (field: string, value: any) => {
    if (user) {
      ...
      await setDoc(routeDoc, updateData, { merge: true }); 
      }
  };
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <IonItem>
          ...
          <IonSelect value={methodOfTravel} placeholder="Select Travel Method" onIonChange={(e) => {
              setMethodOfTravel(e.detail.value);
              handleFieldUpdate('methodOfTravel', e.detail.value); 
            }}>
        ...
        <IonItem>
          ...
          <IonInput
            ...
            onIonChange={(e) => {
              ...
              handleFieldUpdate('estimatedTime', e.detail.value!); 
            }}
            required
            placeholder="minutes"
      ...
      <IonButton expand="full"  onClick={handleAddStop}>
          ...
          <IonButton expand="full" 
            ...
            disabled={!startLocation || !endLocation || !estimatedTime} 
          >
            Save Route
          </IonButton>
