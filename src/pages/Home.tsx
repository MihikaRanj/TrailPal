  ...
  return (
    <IonPage>
      ...
      <IonText>
          ...
          <b>Settings</b>- On this page, you will get to input some important information used in all of your trackings. This includes 
          the number of miles that one is allowed to deviate away from their path, as well as the number of minutes that one 
          is allowed to deviate from their original estimated travel time before their contact is alerted. You will also be able to 
          input your first and last name, which will be used when composing a message sent to the user, and lastly the number of miles 
          that every time one travels that distance, their location will be polled (this is used to track whether you are moving towards the 
          destination of your choice)..<br /><br />
        </IonText>
      </IonContent>
      <BottomBar/>
    </IonPage>
